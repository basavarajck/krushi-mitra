...
import { LeafIcon, ArrowLeftIcon, MegaphoneIcon } from '../components/icons/Icons';
      ...
      <main className="flex-1 flex flex-col p-6 bg-gray-50 dark:bg-gray-800/50 overflow-y-auto">
        <div className="mb-6">
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white flex items-center gap-3">
                <MegaphoneIcon className="h-8 w-8 text-yellow-500" />
                <span>Government Agricultural Schemes</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-400">
                Relevant schemes for farmers in {profile.location}.
            </p>
        </div>
